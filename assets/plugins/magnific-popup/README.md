...
[![Flattr](//api.flattr.com/button/flattr-badge-large.png)](https://flattr.com/thing/1310305/Magnific-Popup-by-dimsemenov)

Fast, light and responsive lightbox plugin, for jQuery and Zepto.js.

- [Documentation and getting started guide](//dimsemenov.com/plugins/magnific-popup/documentation.html).
- [Examples and plugin home page](//dimsemenov.com/plugins/magnific-popup/).
- More examples in [CodePen collection](//codepen.io/collection/nLcqo).
...
- WordPress plugin - [under development](//dimsemenov.com/plugins/magnific-popup/wordpress.html).
- [Drupal module](https://drupal.org/project/magnific_popup).
- [Concrete5 add-on](https://github.com/cdowdy/concrete5-Magnific-Popup).
- [Redaxo add-on](//www.redaxo.org/de/download/addons/?addon_id=1131).
...
- Generated popup JS and CSS files are in folder [dist/](https://github.com/dimsemenov/Magnific-Popup/tree/master/dist). (Online build tool is on [documentation page](//dimsemenov.com/plugins/magnific-popup/documentation.html)).
...
To compile Magnific Popup by yourself, first of make sure that you have [Node.js](//nodejs.org/), [Grunt.js](https://github.com/cowboy/grunt), [Ruby](//www.ruby-lang.org/) and [Jekyll](https://github.com/mojombo/jekyll/) installed, then:
...
Script is MIT licensed and free and will always be kept this way. But has a small restriction from me - please do not create public WordPress plugin based on it(or at least contact me before creating it), because I will make it and it'll be open source too ([want to get notified?](//dimsemenov.com/subscribe.html)).

Created by [@dimsemenov](//twitter.com/dimsemenov) & [contributors](https://github.com/dimsemenov/Magnific-Popup/contributors).
